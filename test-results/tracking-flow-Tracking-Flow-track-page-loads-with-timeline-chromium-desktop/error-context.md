...
- Name: tracking-flow.spec.ts >> Tracking Flow >> track page loads with timeline
- Location: e2e\tracking-flow.spec.ts:4:3
...
Locator: locator('text=Track|Order|Status|Timeline').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Track|Order|Status|Timeline').first()

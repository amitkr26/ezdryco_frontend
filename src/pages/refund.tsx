...
const POLICY = [
  ...
  { title: "Damaged or Lost Items", content: "If any item is returned damaged due to our handling, or if an item is lost, EZDRY will compensate up to ₹2,000 per item based on the documented purchase value. Claims must be filed within 24 hours of delivery via WhatsApp (+91 96718 69470) or email (dryco7718@gmail.com) with photographs." },
